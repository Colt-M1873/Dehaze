clear
%origImg=imread('C:\Users\lenovo\Desktop\复现论文\DehazeCode\MistyAvenue.jpg');
origImg=imread('C:\Users\yangjianan\Desktop\Dehaze\DehazeNet_MATLAB\DehazeNet_MATLAB\DehazeNet-master\data\5.png');
...
%关于那个评价标准结构相似性SSIM的论文我还没看懂，不太清楚那些不同模板大小的结果哪个更好
...
%Y=ordfilt2(dark_channel_image,1,ones(30,30));%最小值h滤波，与平坦结构腐蚀等价
dark_channel_Img = uint8(dark_channel_Img);
%figure(2)

%取原亮度最小图像的前0.1，而论文中写的是按暗原色通道图像的前百分之0.1的位置去找原图中的亮度
...
imwrite(dehazedImg,['C:\Users\yangjianan\Desktop\Dehaze\DehazeNet_MATLAB\DehazeNet_MATLAB\DehazeNet-master\data\5_dehazed.png']);
% figure(2)
% imshow(dehazedImg)
% title("去雾后");
